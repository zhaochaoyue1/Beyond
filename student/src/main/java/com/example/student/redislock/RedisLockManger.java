package com.example.student.redislock;

import com.example.student.redis.RedisManager;
...
public class RedisLockManger {
    ...
    @Autowired
    private RedisUtilCustom dragonJedisClusterClient;
    ...
    public Boolean lock(final String lockKey, final String requestId, final int expireTime) {
        String val = dragonJedisClusterClient.set(lockKey, requestId, "nx", "ex", expireTime);
    ...
    public Boolean tryLock(String lockKey, String requestId, int expireTime) {
        ...
        log.error("redis tryLock fail lockKey:{}, requestId:{}, expireTime:{}", lockKey, requestId, expireTime);
        return false;
    }
}
